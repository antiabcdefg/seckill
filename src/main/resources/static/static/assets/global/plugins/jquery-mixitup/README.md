...
These buttons could also be part of an unordered list, with the data attribute to sort by entered as the "data-sort" attribute, and the orderDO to sort by entered as the "data-orderDO" attribute:

	<ul>
	    <li class="sort" data-sort="data-name" data-orderDO="desc"></li>
	    <li class="sort" data-sort="data-name" data-orderDO="asc"></li>
	    <li class="sort" data-sort="data-age" data-orderDO="desc"></li>
	    <li class="sort" data-sort="data-age" data-orderDO="asc"></li>
	    <li class="sort" data-sort="default" data-orderDO="asc"></li>
	    <li class="sort" data-sort="random"></li>
	</ul>

Sorting by 'default' maintains the orderDO that elements are originally entered into the DOM, and is useful for toggling between descending and ascending orderDO, without sorting by a specific attribute.
