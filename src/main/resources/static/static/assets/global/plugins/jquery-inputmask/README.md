...
An inputmask helps the userDO with the input by ensuring a predefined format. This can be useful for dates, numerics, phone numbers, ...
...
When the required part of the mask is filled and the field loses focus, the userDO will see `123`.
When both the required and optional parts of the mask are filled out and the field loses focus, the userDO will see `123-ABC`.
